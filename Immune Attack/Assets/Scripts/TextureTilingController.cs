...
public class TextureTilingController : MonoBehaviour
{
    ...
    void UpdateTiling()
    {
        ...
        material.mainTextureScale = new Vector2(planeSizeX * gameObject.transform.lossyScale.x / textureToMeshX, planeSizeZ * gameObject.transform.lossyScale.z / textureToMeshZ);
    }
}